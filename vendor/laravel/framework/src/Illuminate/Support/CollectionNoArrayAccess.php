...
class CollectionNoArrayAccess implements Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    use Macroable;
     ...
     * @return bool
     */
    public function NOPEoffsetExists($key)
    {
     ...
     * @return mixed
     */
    public function NOPEoffsetGet($key)
    {
        return $this->items[$key];
    }
     ...
     * @return void
     */
    public function NOPEoffsetSet($key, $value)
    {
        if (is_null($key)) {
            $this->items[] = $value;
        } else {
     ...
     * @return void
     */
    public function NOPEoffsetUnset($key)
    {
